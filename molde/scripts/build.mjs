...
//
// Forma del sitio: home = vitrina de tienda (hero, fotos, colecciones).
// El índice completo vive en /catalogo/. El JS solo suma sesión y carrito.

import { readFile, writeFile, mkdir, cp, rm } from "node:fs/promises";
import { join, dirname } from "node:path";
import { fileURLToPath } from "node:url";
import { htmlVitrina } from "./vitrina.mjs";
import { paraSelector, leerPaletasLocal, hornearPaletas, textoBoot } from "./paletas.mjs";
import { htmlTopbar, htmlPie, htmlDialogoSesion, htmlPaginaAdmin } from "./marco.mjs";
...
const CONTRATO = `<!--
THESIS: el home es la tienda ya abierta — vitrina con foto, colecciones y piezas en sala — no un índice por departamento; el catálogo completo queda un clic más adentro.
OWN-WORLD: tokens --is-* y piezas msl-vitrina-* sobre is-card/is-button; la paleta del tenant pinta hero, mosaico y bandas.
STORY: el visitante siente el local, elige una colección o una pieza, entra a la ficha y pide por WhatsApp.
FIRST VIEWPORT: marca a escala de portada, una foto de producto a sangre y dos llamadas: entrar a la tienda o ver la pieza.
FORM: vitrina editorial de comercio real (candidato 2 de la lista ordenada; seed e576508a).
